...
private fun recordInitialMarginForView(view: View): InitialMargin {
    val lp = view.layoutParams as? ViewGroup.MarginLayoutParams
        ?: error("Invalid view layout params")
...
fun ImageView.bindAnimationSrc(previousBitmap: Bitmap?, bitmap: Bitmap?) {
    if (previousBitmap != bitmap && bitmap != null) setImageBitmap(bitmap)
}

@BindingAdapter("errorText")
fun TextInputLayout.bindErrorText(@StringRes previousStringRes: Int?, @StringRes stringRes: Int?) {
